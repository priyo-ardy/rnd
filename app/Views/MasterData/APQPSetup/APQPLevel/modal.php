...
<div class="modal fade" id="modalDocument" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
        <!-- <div class=""> -->
        <form id="formDocument" class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-primary mb-0" id="tableDocument">
                        <thead class="sticky-top z-1">
                            <tr>
                                <th class="text-center align-middle bg-secondary-subtle col-4 shadow-sm">Document Name</th>
                                <th class="text-center align-middle bg-secondary-subtle col-3 shadow-sm">Uploader</th>
                                <th class="text-center align-middle bg-secondary-subtle col-2 shadow-sm">Document Level</th>
                                <th class="text-center align-middle bg-secondary-subtle col-3 shadow-sm">Action</th>
                            </tr>
                        </thead>
