            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active">List of Material Category</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="card rounded-0 card-primary card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="data_code" id="data_code" class="form-control rounded-0 bg-secondary-subtle" readonly placeholder="Material Category Code" readonly>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">Name <strong class="text-danger">*</strong></label>
                                    <input type="text" name="data_name" id="data_name" class="form-control rounded-0" required maxlength="150" autofocus autocomplete="off" placeholder="Material Category Name">
