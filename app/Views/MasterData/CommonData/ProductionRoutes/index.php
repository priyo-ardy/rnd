            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active">List of Production Routes</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="card rounded-0 card-primary card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="data_code" id="data_code" class="form-control rounded-0 bg-secondary-subtle" readonly placeholder="Production Routes Code" readonly>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">Name <strong class="text-danger">*</strong></label>
                                    <input type="text" name="data_name" id="data_name" class="form-control rounded-0" required maxlength="150" autofocus autocomplete="off" placeholder="Production Routes Name">
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">Routes <strong class="text-danger">*</strong></label>
                                    <input type="text" name="data_simbol" id="data_simbol" class="form-control rounded-0" required maxlength="150" autofocus autocomplete="off" placeholder="Production Routes">
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group mb-3">
                ...
                <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 mb3 clearfix">
                    <div class="card card-primary card-outline rounded-0">
                        <div class="card-header rounded-0">
                            <h5 class="card-title"><i class="bi bi-list-ul"></i>&ensp;Production Routes List</h5>
                                ...
                                <table class="table table-striped table-hover table-primary" id="dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center align-middle bg-secondary-subtle">Routes</th>
