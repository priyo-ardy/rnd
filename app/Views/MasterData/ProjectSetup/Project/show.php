                    ...
                    <div class="card card-primary card-outline rounded-0">
                        <form id="formDocument">
                            ...
                            <div class="card-footer">
                                <input type="hidden" class="form-control rounded-0" name="id_project" readonly id="id_project" value="<?= $data_header->id ?>">
                                <input type="hidden" class="form-control rounded-0" name="id_material" readonly id="id_material" value="">
                                <input type="hidden" class="form-control rounded-0" name="id_apqp" readonly id="id_apqp" value="">
            ...
            <div class="row g-2 mb-3">
                <div class="col-12">
                    <div class="card rounded-0">
                        <div class="card-body">
                            <button class="btn btn-success rounded-0 w-100 d-block" id="btnStartProject">Complete & Start Project</button>
                        </div>
                    </div>
                </div>
            </div>
